...
namespace SmartAdmin.Seed
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddJsReport(new LocalReporting().UseBinary(
               RuntimeInformation.IsOSPlatform(OSPlatform.Linux) ?
               jsreport.Binary.Linux.JsReportBinary.GetBinary() :
               jsreport.Binary.JsReportBinary.GetBinary())
               .Configure(cfg => new jsreport.Types.Configuration { HttpPort = 3197 })                    
               .AsUtility().Create());
            ...
            services.AddDataProtection()
                .PersistKeysToFileSystem(new DirectoryInfo(@"\Configuration\keys"));
            ...
            services.Add(ServiceDescriptor.Singleton<IReportingService>(new ReportingService(settings.ReportingServer)));
        }
